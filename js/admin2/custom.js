$(function() {
    ...
    acoesListagem = $('.widget.acoesListagem a').length;
    if(acoesListagem == 0){
        $('.widget.acoesListagem').hide();
    }
    ...
    $(".currency").spinner(opts['currency']);  
    $(".numberSpinner").spinner(opts['s4']);  
    ...
    oTable = $('#example,.dynamicTable').dataTable({
        "bJQueryUI": true,
    ...
    $( ".datepicker,.inputDate" ).datepicker({ 
        defaultDate: +7,
        autoSize: true,
    ...
    $( ".datepickerInline,.inputDateInline" ).datepicker({ 
        defaultDate: +7,
        autoSize: true,
        appendText: '(dd-mm-yyyy)',
        dateFormat: 'dd-mm-yy',
...
function initsForm(){
    $( ".datepicker,.inputDate,.datepickerInline,.inputDateInline" ).removeClass('hasDatepicker').removeAttr('id');
    $("span.ui-datepicker-append").remove();
    $( ".datepicker,.inputDate" ).datepicker({ 
        defaultDate: +7,
        autoSize: true,
        appendText: '(dd/mm/yyyy)',
