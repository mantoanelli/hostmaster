...
<div id="content2"> 
    ...
    <input type="button" class="btFiltro" onclick="open('<?=site_url('adm/newsletter/download')?>','','')" value="Download da base" style="width: auto; padding: 3px 10px">
                                    ...
                                    <? foreach ($listagem['rows'] as $k => $v): ?>
                                        <tr idRegistro="<?=$v->getId()?>">
                                            ...
                                            foreach ($camposGrid as $campo => $field):
                                                if ($field['visible']):
                                                    ?>
                                                    <td class="tituloTabela" style="text-align: <?= $field['align'] ?>">
                                                        <p>
                                                            <?
